...
<!-- <input type="text" id="searchInput" placeholder="Search students..." style="padding: 5px; width: 200px; border: 1px solid #ccc; border-radius: 4px;"> -->
<hr>
</form>
<?php
$result = mysqli_query($conn, "select * from tbl_course");
...
document.addEventListener('DOMContentLoaded', function() {
    // This ensures the page loads with all students visible
});
</script>
