...
if (isset($_GET['query'])) {
    ...
    if (empty($search)) {
        ...
        $query = "SELECT * FROM tbl_student ORDER BY lname, fname";
    } else {
        // Search in first name, middle name, last name, course, and level
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<tr><td colspan="5" style="text-align:center; color:red;">No students found matching your search.</td></tr>';
    }
}
?>
